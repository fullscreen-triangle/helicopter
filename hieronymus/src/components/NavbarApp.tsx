...
const navLinks = [
  ...
  { href: '/tools/analysis-studio', title: 'Analysis Studio' },
  { href: '/tools/scope-playground', title: 'SCOPE' },
  { href: '/tools/mic-demo', title: 'MIC Demo' },
  { href: '/tools/microscopy-viewer', title: 'Micro Viewer' },
  { href: '/tools/cell-viewer-3d', title: '3D Cell' },
  { href: '/tools/cell-platform', title: 'Cell Platform' },
