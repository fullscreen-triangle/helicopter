...
\author{
Kundai Sachikonye \\
\small \textit{Department of Computer Vision \& Categorical Computation} \\
\small \href{https://github.com/fullscreen-triangle/lavoisier}{\texttt{github.com/fullscreen-triangle/lavoisier}}
}
...
\input{sections/categorical-temporal-encoding}
\input{sections/multi-detector-wavelength-sequences}
\input{sections/adaptive-time-integration}
\input{sections/fractral-temporal-architecture}
\input{sections/motion-picture-pixel-maxwell-demon}
