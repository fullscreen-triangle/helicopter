...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{heihachi-architecture-overview.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth,keepaspectratio]{gas-molecular-ensemble.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{perturbation-restoration-process.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{minimum-variance-optimization.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{performance-benchmarks.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{fire-interface-integration.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{mixed-gas-audio-synthesis.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{social-component-sharing.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{molecular-daw-interface.pdf}
